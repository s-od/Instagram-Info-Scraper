...
def post( username = "indianairforce", p1 = 1, p2 = 1, directory='instagram_downloads',usernamedirectory='User'):
    """
    ...
    try:
        p_dir=""
        path = os.path.join(p_dir, directory, usernamedirectory)
        os.mkdir(path,0o777)
    except FileExistsError:
        print("")
    ...
    if temp["is_video"]:
        ...
        output = open(directory+usernamedirectory+username +"_"+str(p1)+ ".mp4", "wb")
        ...
        img.show()
        img.save(directory+usernamedirectory+username+"_"+str(p1)+"_"+str(p2)+".jpg")
        
        
def profile_pic( username = "mcytjxy", directory='instagram_downloads',usernamedirectory='User' ):
    """
    ...
    img = Image.open(BytesIO(response))
    img.show()
    img.save(directory+usernamedirectory+username+"_"+"profile_pic.jpg")
